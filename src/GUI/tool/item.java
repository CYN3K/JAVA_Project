...
public class item extends JPanel implements MouseListener{
    ...
    public item(String s,Rectangle r,String img,String imgActive )
    {
        name = s;
        lb = new JLabel(name);
        this.img = img;
    ...
    public item(String s,Rectangle r,String img,String imgActive,String imgHover,Color hover)
    {
        name = s;
        lb = new JLabel(name);
        this.img = img;
    ...
    public item(String s,Rectangle r)
    {
        lb = new JLabel(s);
        icon = new JLabel();
        rec = r;
