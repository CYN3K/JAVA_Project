...
public class BanHangGUI extends JPanel implements MouseListener {
	...
	private void init() {
        ...
        txtSearch = new JTextField();
         ...
         xacnhan.addActionListener(new ActionListener() {
         	public void actionPerformed(ActionEvent e) {
         		if(!masplabel.getText().equals("null")) {
              ...
              //"Mã SP", "Tên SP", "Giá", "Số lượng", "Đơn Vị Tính", "Nhà Sản Xuất", "Mã Loại"
                ...
                hientong.setText(String.valueOf(tongtien(cthd)));
         		...
         		else JOptionPane.showMessageDialog(null, "xin chọn sản phẩm");
         	}
         });
        ...
        masplabel.setText("null");
        tenlabel.setText("null");
        nsxlabel.setText("null");
        gialabel.setText("null");
        dvtlabel.setText("null");
        loailabel.setText("null");
        ...
        khachhangbox.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		if(khachhangbox.getSelectedIndex()!=0)khuyenmaibox.setEnabled(true);
        		else {
        			khuyenmaibox.setSelectedIndex(0);
        			khuyenmaibox.setEnabled(false);
        		}
        ...
        thanhtoan.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(cthdbuss.getList()==null)cthdbuss.list();
				if(cthdbuss.getList()==null)cthdbuss.getList();
        		...
        		else JOptionPane.showMessageDialog(null, "giỏ hàng đang trống mời thêm sản phẩm");
        	}
